...
int _customListEstimateSize(
  ...
  bytesCount += 3 + object.hymnsIds.length * 8;
  {
...
void _customListSerialize(
  ...
  writer.writeLongList(offsets[0], object.hymnsIds);
...
CustomList _customListDeserialize(
  ...
  object.hymnsIds = reader.readLongList(offsets[0]) ?? [];
  object.id = id;
  return object;
}
...
extension CustomListQueryFilter
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition>
      hymnsIdsElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition>
      hymnsIdsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> indexIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> indexIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> indexEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'index',
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> indexGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> indexLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> indexBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<CustomList, CustomList, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
...
extension CustomListQuerySortBy
  ...
  QueryBuilder<CustomList, CustomList, QAfterSortBy> sortByIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'index', Sort.asc);
    });
  }

  QueryBuilder<CustomList, CustomList, QAfterSortBy> sortByIndexDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomListQuerySortThenBy
  ...
  QueryBuilder<CustomList, CustomList, QAfterSortBy> thenByIndex() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'index', Sort.asc);
    });
  }

  QueryBuilder<CustomList, CustomList, QAfterSortBy> thenByIndexDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'index', Sort.desc);
    });
  }
...
extension CustomListQueryWhereDistinct
  ...
  QueryBuilder<CustomList, CustomList, QDistinct> distinctByHymnsIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'hymnsIds');
    });
  }

  QueryBuilder<CustomList, CustomList, QDistinct> distinctByIndex() {
    return QueryBuilder.apply(this, (query) {
...
extension CustomListQueryProperty
  ...
  QueryBuilder<CustomList, List<int>, QQueryOperations> hymnsIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'hymnsIds');
    });
  }

  QueryBuilder<CustomList, int?, QQueryOperations> indexProperty() {
    return QueryBuilder.apply(this, (query) {
